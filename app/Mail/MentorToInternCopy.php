...
class MentorToInternCopy extends Mailable
{
    ...
    {
        return $this->view('emails.mentor_to_intern_copy')
                    ->subject("Copy: {$this->subjectLine} (to {$this->intern->first_name} {$this->intern->last_name})");
    }
}