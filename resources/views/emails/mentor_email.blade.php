...
<body>
    <div class="email-wrapper">
        ...
        <div class="email-body">
            <div class="greeting">
                Hi {{ $mentor->first_name ?? 'Mentor' }},
            </div>
            
            <div class="message">
                {!! nl2br(e($messageBody)) !!}
                
                <!-- Optional button - can be uncommented when needed -->
                <!-- <div class="button-container">
                    <a href="#" class="action-button">View Dashboard</a>
                </div> -->
                
                <!-- Optional highlight box - can be uncommented when needed -->
                <!-- <div class="highlight-box">
                    <div class="highlight-title">Important Reminder</div>
                    <p>Weekly mentor reports are due every Friday by 5:00 PM.</p>
                </div> -->
            </div>
        ...
        <div class="email-footer">
            ...
            <p>This email was sent to you as part of the Ilinix Internship Program.</p>
        </div>
    </div>
</body>
</html>