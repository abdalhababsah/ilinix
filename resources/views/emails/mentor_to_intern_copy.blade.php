...
<body>
    <div class="email-wrapper">
        ...
        <div class="email-body">
            ...
            <div class="message">
                <p>This is a copy of the email you sent to {{ $intern->first_name }} {{ $intern->last_name }}.</p>
                
                <div style="padding: 15px; border-left: 3px solid #5ace5a; background-color: #f9fafb; margin: 20px 0;">
